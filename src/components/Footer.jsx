...
const links = {
  Services: ['Coaching Sessions', 'Caregiver Kits', 'Consulting', 'Mini-Courses'],
  Resources: ['Free Guides', 'Checklists', 'Workbooks', 'Toolkits'],
  Company: ['About Us', 'Speaking', 'Blog', 'Contact'],
}
      ...
      <div className="container">
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Empowering caregivers, seniors, and wellness seekers with practical,
              accessible support — one bridge at a time.
            </p>
        ...
        <div className={styles.bottom}>
          <p className={styles.copy}>
            © {new Date().getFullYear()} BridgePoint Wellness, LLC. All rights reserved.
          </p>
